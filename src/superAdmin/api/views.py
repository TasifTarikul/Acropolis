...
class UserViewSet(viewsets.ModelViewSet):
	...
	def get_queryset(self):
		...
		if order_by_client_status == 'asc':
			order_by_args.insert(0, 'acropolismodel__client_status')
	...
	filterset_fields = ('id', 'acropolismodel__country_of_residence', 'acropolismodel__application_status', 'acropolismodel__nationality', 'acropolismodel__client_status', 'sarawakmodel__gender')
